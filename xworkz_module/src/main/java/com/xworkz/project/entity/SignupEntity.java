...
@NamedQuery(name = "updateExistingDetailsByName", query = "UPDATE SignupEntity a SET a.email=:setEmail,a.phoneNo=:setPhoneNo,a.altEmail=:setAltEmail,a.altPhhoneNo=:setaltPhoneNo,a.location=:setLocation WHERE a.name=:setName")
